...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String substringNamespace(String fullTableName) {
        String separator = ":";
        if (!isEmpty(fullTableName)) {
            int pos = fullTableName.indexOf(separator);
            return pos == -1 ? "default" : fullTableName.substring(0, pos);
        } else {
            return "";
        }
    }

    public static String substringTableName(String fullTableName) {
        String separator = ":";
        if (!isEmpty(fullTableName)) {
            int pos = fullTableName.indexOf(separator);
