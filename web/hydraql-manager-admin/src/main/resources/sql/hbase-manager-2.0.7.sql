...
INSERT INTO `sys_menu`
VALUES (2001, '命名空间查询', 2000, 1, '#', 'menuItem', 'F', '0', 'hbase:namespace:list', '#', 'admin',
        '2018-03-01 00:00:00', 'admin', '2020-11-08 04:34:55', '');
INSERT INTO `sys_menu`
VALUES (2002, '命名空间新增', 2000, 2, '#', 'menuItem', 'F', '0', 'hbase:namespace:add', '#', 'admin', '2018-03-01 00:00:00',
        'admin', '2020-11-08 04:35:07', '');
INSERT INTO `sys_menu`
VALUES (2003, '命名空间修改', 2000, 3, '#', 'menuItem', 'F', '0', 'hbase:namespace:edit', '#', 'admin',
        '2018-03-01 00:00:00', 'admin', '2020-11-08 04:35:17', '');
INSERT INTO `sys_menu`
VALUES (2004, '命名空间删除', 2000, 4, '#', 'menuItem', 'F', '0', 'hbase:namespace:remove', '#', 'admin',
        '2018-03-01 00:00:00', 'admin', '2020-11-08 04:35:31', '');
INSERT INTO `sys_menu`
VALUES (2005, '命名空间导出', 2000, 5, '#', 'menuItem', 'F', '0', 'hbase:namespace:export', '#', 'admin',
...
INSERT INTO `sys_menu`
VALUES (2014, 'HBase标签查询', 2013, 1, '#', 'menuItem', 'F', '0', 'hbase:tag:list', '#', 'admin', '2018-03-01 00:00:00',
        'admin', '2020-11-08 04:36:40', '');
INSERT INTO `sys_menu`
VALUES (2015, 'HBase标签新增', 2013, 2, '#', 'menuItem', 'F', '0', 'hbase:tag:add', '#', 'admin', '2018-03-01 00:00:00',
        'admin', '2020-11-08 04:36:50', '');
INSERT INTO `sys_menu`
VALUES (2016, 'HBase标签修改', 2013, 3, '#', 'menuItem', 'F', '0', 'hbase:tag:edit', '#', 'admin', '2018-03-01 00:00:00',
        'admin', '2020-11-08 04:37:00', '');
INSERT INTO `sys_menu`
VALUES (2018, 'HBase标签导出', 2013, 4, '#', 'menuItem', 'F', '0', 'hbase:tag:export', '#', 'admin', '2018-03-01 00:00:00',
        'admin', '2020-11-08 04:43:08', '');
INSERT INTO `sys_menu`
VALUES (2019, 'HBase表详情', 2007, 6, '#', 'menuItem', 'F', '0', 'hbase:table:detail', '#', 'admin',
...
INSERT INTO `sys_menu`
VALUES (2021, 'HBase列簇查看', 2020, 1, '#', 'menuItem', 'F', '0', 'hbase:family:list', '#', 'admin',
...
VALUES (2031, 'HBase表数据导出', 2026, 5, '#', '', 'F', '0', 'hbase:data:export', '#', 'admin', '2018-03-01 00:00:00',
        'leo', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu`
VALUES (2032, 'HBase表清空', 2007, 7, '#', 'menuItem', 'F', '0', 'hbase:table:clear', '#', 'admin', '2020-11-08 04:30:37',
        '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2033, 'HBase标签删除', 2013, 5, '#', 'menuItem', 'F', '0', 'hbase:tag:remove', '#', 'admin', '2020-11-08 04:42:54',
        '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2034, 'HBase表数据详情', 2026, 6, '#', 'menuItem', 'F', '0', 'hbase:data:detail', '#', 'admin',
        '2020-11-08 13:27:51', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2035, 'HBase表快照管理', 2006, 6, '/system/snapshot', 'menuItem', 'C', '0', 'hbase:snapshot:view', '#', 'admin',
        '2020-11-14 12:06:12', 'admin', '2020-11-14 12:06:24', '');
INSERT INTO `sys_menu`
VALUES (2036, '快照查询', 2035, 1, '#', 'menuItem', 'F', '0', 'hbase:snapshot:list', '#', 'admin', '2020-11-14 12:07:13',
        'admin', '2020-11-14 12:15:18', '');
INSERT INTO `sys_menu`
VALUES (2037, '快照添加', 2035, 2, '#', 'menuItem', 'F', '0', 'hbase:snapshot:add', '#', 'admin', '2020-11-14 13:07:09',
        '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2038, '快照删除', 2035, 3, '#', 'menuItem', 'F', '0', 'hbase:snapshot:remove', '#', 'admin', '2020-11-14 13:07:46',
        '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2039, 'HBaseSQL', 2006, 7, '/system/sql', 'menuItem', 'C', '0', 'hbase:sql:view', '#', 'admin',
        '2020-11-29 03:58:49', 'admin', '2020-11-29 03:59:47', '');
INSERT INTO `sys_menu`
VALUES (2040, 'HBaseTableSchema', 2006, 8, '/system/schema', 'menuItem', 'C', '0', 'hbase:schema:view', '#', 'admin',
        '2020-11-29 06:10:38', 'admin', '2020-11-29 06:10:59', '');
INSERT INTO `sys_menu`
VALUES (2041, 'HBaseSQLQuery', 2039, 1, '#', 'menuItem', 'F', '0', 'hbase:sql:query', '#', 'admin',
        '2020-12-12 14:56:19', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2042, 'HBaseTableSchema新增', 2040, 1, '#', 'menuItem', 'F', '0', 'hbase:schema:add', '#', 'admin',
        '2020-12-12 14:57:18', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2043, 'HBaseTableSchema查询', 2040, 2, '#', 'menuItem', 'F', '0', 'hbase:schema:list', '#', 'admin',
        '2020-12-12 14:57:50', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2044, 'HBaseTableSchema移除', 2040, 3, '#', 'menuItem', 'F', '0', 'hbase:schema:remove', '#', 'admin',
