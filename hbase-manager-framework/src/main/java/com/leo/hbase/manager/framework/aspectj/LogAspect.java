package com.leo.hbase.manager.framework.aspectj;
...
import com.leo.hbase.manager.common.enums.BusinessStatus;
import com.leo.hbase.manager.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.leo.hbase.manager.common.annotation.Log)")
