 ...
 */
public class CustomSystemRegistryImpl implements SystemRegistry {
    ...
    public CustomSystemRegistryImpl(Parser parser, Terminal terminal, Supplier<Path> workDir, ConfigurationPath configPath) {
        this.parser = parser;
    ...
    public CustomSystemRegistryImpl groupCommandsInHelp(boolean commandGroups) {
        this.commandGroups = commandGroups;
        return this;
    }
